                        ...
                        <DialogPanel
                            ...
                            <div class="px-4">
                                        ...
                                        <div class="mx-auto w-full">
                                            <v-stepper model-value="1" style="box-shadow: none; height: auto;"
                                                ...
                                                <v-stepper-header style="box-shadow: none;">
                                                    ...
                                                    <v-stepper-item title="Unggah Foto Profil & Pilih Role" value="2"
                                                        class="font-semibold"></v-stepper-item>
                                                </v-stepper-header>
                                            </v-stepper>
                                            ...
                                            <div class="-mx-3 flex flex-wrap">
                                                <div class="w-full px-3 sm:w-1/2">
                                                    <div class="mb-2">
                                                        ...
                                                        <ErrorMessage class="flex text-red-500 text-sm bg-red-200 w-full h-full p-2 mt-2 rounded" name="username" />
                                                        </div>
                                                </div>
                                                <div class="w-full px-3 sm:w-1/2">
                                                    <div class="mb-2">
                                                ...
                                                <div class="w-full px-3 sm:w-1/2">
                                                    <div class="mb-2">
                                                        ...
                                                        <Field type="text" name="nohp" id="nohp"
                                                            ...
                                                            @keydown="checkDigit"
                                                            class="w-full rounded-md block border py-1.5 px-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6" />
                                                            <ErrorMessage class="flex text-red-500 text-sm bg-red-200 w-full h-full p-2 mt-2 rounded" name="nohp" />
                                                        </div>
                                                </div>
                                                <div class="w-full px-3 sm:w-1/2">
                                                    <div class="mb-2">
                                                        ...
                                                        <Field 
                                                        :rules="validateJK" 
                                                        id="jk" name="jk" as="select" class="w-full rounded-md block border py-1.5 px-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                                                        <option value="">Pilih Jenis Kelamin</option>
                                                        <option value="Pria">Pria</option>
                                                        <option value="Wanita">Wanita</option>
                                                        </Field>
                                                        <ErrorMessage class="flex text-red-500 text-sm bg-red-200 w-full h-full p-2 mt-2 rounded" name="jk" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="w-full px-3 sm:w-1/2">
                                                    <div class="mb-4">
                                                        ...
                                                        <div class="flex items-center justify-center w-full">
                                                            <img id="uploaded-image" src="@assets/img/Person.jpg"  alt="@assets/img/Person.jpg" className="w-64 h-64 mb-2" />
                                                        </div>
                                                    </div></div>
                                                <div class="w-full px-3 sm:w-1/2">
                                                    <div class="mb-4">
                                                        <div class="flex items-center justify-center w-full mt-8">
                                                            <label for="file-upload" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg">
                                                                ...
                                                                <Field id="file-upload" type="file" class="hidden" accept="image/*" name="file" @change="handleFileUpload"/>
                                                            </label>
                                                        </div>
                                                        <div v-if="userFile64">
                                                            <cropper
                                                        ...
                                                        <ErrorMessage class="flex text-red-500 text-sm bg-red-200 w-full h-full p-2 mt-2 rounded" name="file" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="-mx-3 flex flex-wrap">
                                                <div class="w-full px-3">
                                                    <div class="mb-2">
                                                        ...
                                                        <Field 
                                                        :rules="validateRole"
                                                        id="role" name="role" as="select" class="w-full rounded-md block border py-1.5 px-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                                                            <option value="">Pilih Role</option>
                                                            <option value="Admin">Admin</option>
                                                            <option value="User">User</option>
                                                        </Field>
                                                        <ErrorMessage class="flex text-red-500 text-sm bg-red-200 w-full h-full p-2 mt-2 rounded" name="role" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="flex float-right gap-2 mt-2 mb-5">
                                    ...
                                    <v-btn class="hover:shadow-form rounded-full bg-gradient-to-r from-blue-700 to-blue-500 px-4 py-2 text-center font-semibold text-sm text-white outline-none" v-if="currentStep !== 1" type="submit">Next</v-btn>

                                    <v-btn class="hover:shadow-form rounded-full bg-gradient-to-r from-blue-700 to-blue-500 px-4 py-2 text-center font-semibold text-sm text-white outline-none" v-if="currentStep === 1" type="submit">Submit</v-btn>
                                </div>
                                <!-- <pre>{{ values }}</pre> -->
                            </Form>
                            </div>
...
import { getAllUsers } from '@/services/Pengguna.js';
