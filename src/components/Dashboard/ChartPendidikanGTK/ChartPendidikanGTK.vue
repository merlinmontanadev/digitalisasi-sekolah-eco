...
<script>
import * as chartConfigPendidikan from '@/stores/Chart/chartConfigPendidikanGTK.js'
export default {
  data: function() {
    return {
      chartOptions: {
        ...
        xaxis: chartConfigPendidikan.xaxisLabel,
      },
      series: chartConfigPendidikan.seriesData,
    };
  },
};
</script>