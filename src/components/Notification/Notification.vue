...
<template>
  <div v-if="showWelcomeMessage" class="mb-4 bg-gradient-to-r from-blue-700 to-blue-500 p-4 shadow-md rounded flex items-center transition-opacity duration-500">
