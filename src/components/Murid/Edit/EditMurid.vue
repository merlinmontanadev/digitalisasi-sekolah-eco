...
<template>
  ...
  <div v-else>
    ...
    <img
      ...
      :src="muridFile ? muridFile : defaultPicture"
      id="uploaded-image"
      alt="Profile Picture"
    />
    ...
    <TransitionRoot as="template" :show="isModalOpenPreview">
                ...
                <div class="w-3/6 p-4">
                  ...
                  <div class="flex justify-between items-center py-2">
                    ...
                    <div class="text-right">
                      <p class="text-gray-600 font-medium">{{ muridData.alamat }}, {{ muridData.kel_des }},
                        {{ muridData.kec }}, {{ muridData.kab }}</p>
                    </div>
                  </div>
                  <div class="flex justify-between items-center py-2">
                  ...
                  <div class="flex justify-between items-center py-2">
                    ...
                    <div class="text-right">
                      <p class="text-gray-600 font-medium flex gap-2 items-center justify-end"
                        v-if="muridData.jenis_kelamin">
                        <span
                          :class="muridData.jenis_kelamin === 'Pria' ? 'mdi-gender-male text-blue-500' : 'mdi-gender-female text-pink-500'"
                  ...
                  <div class="flex justify-between items-center py-2">
                    ...
                    <div class="text-right" v-if="muridData.updatedAt">
                      <p class="text-gray-600  flex items-center justify-end gap-2">
                        <CalendarDaysIcon class="h-4 w-4 text-gray-700 text-center justify-center items-center">
                        </CalendarDaysIcon>{{ formatDate(muridData.updatedAt) }}
                      </p>
                      <p class="text-gray-600  flex items-center justify-end gap-2">
                        <ClockIcon class="h-4 w-4 text-gray-700 text-center justify-center items-center"></ClockIcon>
                        {{ formatTime(muridData.updatedAt) }}
                      </p>
                    </div>
                  </div>
                  <v-divider class="my-4" />
